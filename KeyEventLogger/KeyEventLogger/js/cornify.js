//Below code courtesy of https://www.cornify.com/js/cornify.js (with modifications)
...
var cornify_add = function (options) {
    ...
    // When clicking 3 times, add a custom stylesheet to make the page look awesome.
    if (cornify_count == 3) {
